                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Penilaian calon penerima beasiswa</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                        ...
                                        // $queri = "SELECT penilaian.*, siswa.* FROM penilaian, siswa WHERE penilaian.id_siswa=siswa.id";
                                        ...
                                        // print_r ($data);   
                                        $no++;
                                        $currencyFormat = number_format($data[2], 2, ",", ".");
                                        ...
                                        <td>
                                        <!-- <div class=row>
                                            <div class=col-2 style=padding-right:0.8rem>
                                                <a href=edit-data-alternatif.php?id=".$data[0]."><input type=button value=edit class=btn btn-icon-split style=background-color:#f6c23e;color:#fff;></a>
                                            </div>
                                            <div class=col-2>
                                                <a href=delete-alternatif.php?id=".$data[0]." onclick='return checkDelete()'><input type=button value=hapus class=btn btn-success btn-block style=background-color:#e74a3b;color:#fff;></a></td>
                                            </div>
                                        </div> --!>

                                        <a href=edit-data-penilaian.php?id=".$data[0]."><input type=button value=edit class=btn btn-icon-split style=background-color:#f6c23e;color:#fff;margin-bottom:0.5rem></a> 
                                        
                                        <a href=delete-penilaian.php?id=".$data[0]." onclick='return checkDelete()'><input type=button value=hapus class=btn btn-success btn-block style=background-color:#e74a3b;color:#fff;></a></td>
                            ...
                            <div class="row">
                                <div class="col-3" style="padding-right: 0.8rem">
                                    <a href="input-alternatif.php"><input type="button" value="Masukan Data Baru" class="btn btn-success btn-block"></a>
                                </div>
                            </div>    
