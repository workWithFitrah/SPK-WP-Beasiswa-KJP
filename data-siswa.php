                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Siswa calon penerima beasiswa</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <?php
                                    ...
                                    <td>
                                    <center>
                                        <a href=edit-data-siswa.php?id=".$data[0]."><input type=button value=edit class=btn btn-success btn-block style=background-color:#f6c23e;color:#fff;margin-bottom:0.5rem></a>
                                        <a href=delete-siswa.php?id=".$data[0]." onclick='return checkDelete()'><input type=button value=hapus class=btn btn-success btn-block style=background-color:#e74a3b;color:#fff;></a></td>
                                    </center>
                                    </tr>";      
                                    }
                            ...
                            <div class="row">
                                <div class="col-3" style="padding-right: 0.8rem">
                                   <a href="input-siswa.php"><input type="button2" value="Masukan Data Baru" class="btn btn-success btn-block"></a>
                                </div>
                            </div>    
