                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Data Indikator Bobot Kriteria</h6>
                        </div>
                        <div class="card-body">
                            <form name="frm" id="myForm" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-2">
                                        <label for="id">Id Bobot </label>
                                    </div>
                                    <div class="col-10">
                                        <?php
                                            $tampil = "SELECT * FROM bobot2 where id='".$_GET['id']."'";
                                            $sql = mysqli_query ($koneksi,$tampil);
                                            while($data = mysqli_fetch_array ($sql))
                                            {
                                                echo "<input type='number' name='id' class='form-control' id='id' readonly value='".$data[0]."'><br>";
                                            }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <?php
                                            ...
                                            while($data = mysqli_fetch_array ($sql))
                                            {
                                                echo "<input type='text' name='kriteria' class='form-control' id='kriteria' value='".$data[1]."'><br>";
                                            }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <select id="jenis_kriteria" class="col-12" name="jenis_kriteria">
                                            <option>
                                            <?php
                                                $tampil = "SELECT * FROM bobot2 where id='".$_GET['id']."'";
                                                $sql = mysqli_query ($koneksi,$tampil);
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <label for="b_nilai">Nilai Bobot</label>
                                    </div>
                                    <div class="col-10">
                                        <select id="b_nilai" class="col-12" name="b_nilai">
                                            <option>
                                            <?php
                                                $tampil = "SELECT * FROM bobot2 where id='".$_GET['id']."'";
                                                $sql = mysqli_query ($koneksi,$tampil);
                                ...
                                <?php   
                                    if(isset($_POST['submit'])){
                                        ...
                                        $b_nilai             = $_POST['b_nilai'];
                                        $query="UPDATE bobot2 SET id='$id', kriteria='$kriteria', jenis_kriteria='$jenis_kriteria', b_nilai='$b_nilai' WHERE id='$id'";
                                        $result=mysqli_query($koneksi, $query);
                                        if($result){
                                            echo "<script>alert('Data Berhasil Diubah');</script>";
                                            echo "<script>location='data-bobot.php';</script>";
                                        }
                                    }
                                ?>
