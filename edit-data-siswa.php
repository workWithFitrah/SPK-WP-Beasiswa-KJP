                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Data Siswa calon penerima beasiswa</h6>
                        </div>
                        <div class="card-body">
                            <form name="frm" id="myForm" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <?php
                                        $tampil = "SELECT * FROM siswa where id='".$_GET['id']."'";
                                        $sql = mysqli_query ($koneksi,$tampil);
                                        while($data = mysqli_fetch_array ($sql))
                                            {
                                                echo "<input type='number' name='nis' class='form-control' id='nis' readonly value='".$data[1]."'><br>";
                                            }
                                        ?>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        while($data = mysqli_fetch_array ($sql))
                                            {
                                                echo "<input type='text' name='nama' class='form-control' id='nama' value='".$data[2]."'><br>";
                                            }
                                        ?>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        while($data = mysqli_fetch_array ($sql))
                                            {
                                                echo "<input type='date' name='tgl_lahir' class='form-control' id='tgl_lahir' value='".$data[3]."'><br>";
                                            }
                                        ?>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <select id="jenis_kelamin" class="col-12" name="jenis_kelamin">
                                            <option>
                                            <?php
                                                $tampil = "SELECT * FROM siswa where id='".$_GET['id']."'";
                                                $sql = mysqli_query ($koneksi,$tampil);
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                        ...
                                        while($data = mysqli_fetch_array ($sql))
                                        {
                                            echo "<input type='text' name='kelas' class='form-control' id='kelas' value='".$data[5]."'><br>";
                                        }
                                    ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                        ...
                                        while($data = mysqli_fetch_array ($sql))
                                        {
                                            echo "<input type='text' name='alamat' class='form-control' id='alamat' value='".$data[6]."'><br>";
                                        }
                                    ?>
                                    </div>
                                </div>
                                ...
                                <?php   
                                    if(isset($_POST['submit'])){
                                        ...
                                        $kelas        = $_POST['kelas'];
                                        $alamat         = $_POST['alamat'];
                                        $query="UPDATE siswa SET nis='$nis', nama='$nama', tgl_lahir='$tgl_lahir', jenis_kelamin='$jenis_kelamin', kelas='$kelas', alamat='$alamat' WHERE nis='$nis'";
