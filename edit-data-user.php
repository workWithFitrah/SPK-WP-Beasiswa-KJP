                        ...
                        <div class="card-body">
                            <form name="frm" id="myForm" method="post" enctype="multipart/form-data">
                                <div class="row" style="display: none">
                                    ...
                                    <div class="col-10">
                                        <?php
                                        $tampil = "SELECT * FROM user where id='".$_GET['id']."'";
                                        $sql = mysqli_query ($koneksi,$tampil);
                                        while($data = mysqli_fetch_array ($sql))
                                            {
                                                echo "<input type='text' name='id' class='form-control' id='id' value='".$data[0]."'><br>";
                                            }
                                        ?>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        while($data = mysqli_fetch_array ($sql))
                                            {
                                                echo "<input type='text' name='username' class='form-control' id='username' value='".$data[1]."'><br>";
                                            }
                                        ?>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        while($data = mysqli_fetch_array ($sql))
                                            {
                                                echo "<input type='text' name='email' class='form-control' id='email' value='".$data[2]."'><br>";
                                            }
                                        ?>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        while($data = mysqli_fetch_array ($sql))
                                            {
                                                echo "<input type='text' name='password' class='form-control' id='password' placeholder='Masukan password baru'><br>";
                                            }
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <label for="cfmPassword">Konfirmasi Password Baru</label>
                                    </div>
                                    <div class="col-10">
                                        <?php
                                        $tampil = "SELECT * FROM user where id='".$_GET['id']."'";
                                        ...
                                        while($data = mysqli_fetch_array ($sql))
                                            {
                                                echo "<input type='text' name='cfmPassword' class='form-control' id='cfmPassword' placeholder='Konfirmasi password baru'><br>";
                                            }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <select id="level" name="level" class="col-12">
                                        <option>
                                            <?php
                                                $tampil = "SELECT * FROM user where id='".$_GET['id']."'";
                                                $sql = mysqli_query ($koneksi,$tampil);
                                ...
                                <!-- $query="UPDATE user SET id='$id', username='$username', email='$email', password=md5('$password') WHERE id='$id'"; -->
                                ...
                                <?php   
                                    if(isset($_POST['submit'])){
                                        ...
                                        $level     = $_POST['level'];
                                        $query="UPDATE user SET id='$id', username='$username', email='$email',level='$level',";
                                        if(!empty($password) && !empty($cfmPassword)){
                                            if($password == $cfmPassword){
                                                $query .= " password=md5('$password')";

                                            }else{
                                                echo 'Pastikan password yang anda masukan sesuai';
                                            }
                                            $query .= " WHERE id='$id'";
                                        }else{
                                            echo 'Pastikan password yang anda masukan sesuai';
                                        ...
                                        if($result){
                                            ...
                                            echo "<script>location='data-user.php';</script>";
                                        }
                                    }
                                ?>
