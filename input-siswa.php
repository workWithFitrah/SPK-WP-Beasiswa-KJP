                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Input Data Siswa calon penerima beasiswa</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST">
                                <div class="form-group">
                                    <label>Nis :</label>
                                    <input type="number" name="nis" class="form-control" placeholder="Masukan Nomor Induk Siswa" required>
                                </div>
                                <div class="form-group">
                                    <label>Nama :</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_kelamin" class="col-12">
                                ...
                                <div class="form-group">
                                    <label>Kelas :</label>
                                    <input type="text" name="kelas" class="form-control" placeholder="Masukan kelas asal" required>
                                </div>
                                <div class="form-group">
                                    <label>Alamat :</label>
                                    <input type="text" name="alamat" class="form-control" placeholder="Masukan Alamat Siswa" required>
                                </div>
                                <div>
                            ...
                            <?php
                                if (isset($_POST["add"]))
                                {
                                    $koneksi->query("INSERT INTO siswa(nis, nama, tgl_lahir, jenis_kelamin, kelas, alamat) VALUES ('$_POST[nis]', '$_POST[nama]', '$_POST[tgl_lahir]', '$_POST[jenis_kelamin]', '$_POST[kelas]','$_POST[alamat]')");
