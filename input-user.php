                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <form method="POST">
                            ...
                            <div class="form-group">
                                <label>Level :</label>
                                <select name="level" class="col-12">
                                    <option disabled selected>Pilih Level Admin</option>
                        ...
                        <?php
                            if (isset($_POST["add"]))
                            {
                                $koneksi->query("INSERT INTO user(username, email, level, password) VALUES ('$_POST[username]', '$_POST[email]', '$_POST[level]', md5('$_POST[password]'))");
